...
public class TestAll
{
	...
	private static int cabac265(int[] aInput) throws IOException
	{
		...
		{
			CabacContext265[] models = {new CabacContext265(),new CabacContext265(),new CabacContext265(),new CabacContext265(),new CabacContext265(),new CabacContext265(),new CabacContext265(),new CabacContext265(),new CabacContext265(),new CabacContext265(),new CabacContext265(),new CabacContext265(),new CabacContext265()};

			try (CabacEncoder265 encoder = new CabacEncoder265(baos))
			{
				for (int i = 0; i < aInput.length; i++)
				{
					encoder.encodeCABAC_EGk(aInput[i], 0, models);
				}
