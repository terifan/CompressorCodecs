package org.terifan.compression.ppp;
...
//			System.out.println(baos.toString());
	...
	private static void compress(InputStream aInput, byte[] aTable, OutputStream aOutput, boolean aTrain) throws IOException
	{
		byte[] buf = new byte[8];
		int hash = 0;
...
//				hash = ((hash << 4) ^ c) & 0xffff;
	...
	private static void decompress(InputStream aInput, byte[] aTable, OutputStream aOutput, boolean aTrain) throws IOException
	{
		int hash = 0;
