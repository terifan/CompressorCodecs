...
public class BinaryEncoder
{
	...
	public void encodeBit(int aBit, Context aContext) throws IOException
	{
		int low = mLow;
		int bl = mBitsToGo;
	...
	public void encodeUnary(int symbol, Context ctx) throws IOException
	{
		int l = symbol;
		while (l-- > 0)
		{
	...
	public void encodeUnary(int symbol, Context ctx0, Context ctx1) throws IOException
	{
		if (symbol == 0)
		{
			encodeBit(0, ctx0);
	...
	public void encodeExpGolomb(long aSymbol, int aStep, Context aContext) throws IOException
	{
		encodeBitEqProb((int)aSymbol & 1);
		aSymbol >>>= 1;
	...
	public void encodeUnaryGolomb(long aSymbol, int aStep, Context ctx) throws IOException
	{
		if (aStep <= 0 || aStep > 64)
		{
