...
public class BinaryDecoder
{
	...
	public BinaryDecoder(PushbackInputStream aInputStream) throws IOException
	{
	...
	public int decodeBit(Context aContext) throws IOException
	{
	...
	public long decodeExpGolomb(int aStep, Context aContext) throws IOException
	{
		int x = decodeBitEqProb();
	...
	public int decodeUnary(Context ctx) throws IOException
	{
		int symbol = 0;
	...
	public int decodeUnary(Context ctx0, Context ctx1) throws IOException
	{
		if (decodeBit(ctx0) == 0)
		{
			return 0;
	...
	public long decodeUnaryGolomb(int aStep, Context ctx) throws IOException
	{
